module base_state_SK

    implicit none

    contains

    subroutine base_state_SK()
        ...
        !Code to make soudning for Sokolowsky environment
        P_sfc = 1.0122*100*1000;
        !make z grids
        do k = 1, NZ
    ...
    end subroutine base_state_SK
    
end module base_state_SK