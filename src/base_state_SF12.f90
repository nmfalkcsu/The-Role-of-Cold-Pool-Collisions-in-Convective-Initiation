module base_state_SF12

    implicit none

    contains

    subroutine base_state_SF12()
        ...
        !Code to make soudning from SF12 S10
        P_sfc = 1.0091*100*1000;
        !make z grids
        do k = 1, NZ
    ...
    end subroutine base_state_SF12
    
end module base_state_SF12